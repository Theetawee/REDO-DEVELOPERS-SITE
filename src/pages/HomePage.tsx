          ...
          <div className="absolute z-10 px-4 inset-0 flex items-center justify-center bg-gray-900/70">
            <div className="text-center max-w-4xl mx-auto">
              <p className="text-white text-4xl mb-6">
                <span className="text-primary-400">Better Software</span> =
                Better{" "}
              ...
              <div className="flex items-center justify-center">
                <LinkTag
                  to="/contact"
                  label="Contact us"
                  className="border hover:bg-white/10 border-white text-white px-6 py-2.5 text-lg font-medium"
                />
                <LinkTag
                  to={"/products"}
                                className="py-2.5 hidden sm:block px-6 bg-primary-400 text-white ml-6 text-lg font-medium hover:bg-primary-500/80"
