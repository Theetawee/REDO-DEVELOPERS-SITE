...
const Input = ({
    ...
    const textClass =
        "block px-2 pb-2  pt-4 w-full text-sm focus:ring-primary-600 text-gray-900 bg-transparent rounded border border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-primary-500 focus:outline-none focus:ring-1 focus:border-primary-600 peer";
                    ...
                    {type === "password" && (
                        <div className="absolute  top-[15px] right-4">
                            {passwordType === "text" ? (
                                ...
                                >
                                    <EyeSlashIcon className="w-4 text-gray-600 h-4" />
                                </span>
                            ) : (
                                <span
